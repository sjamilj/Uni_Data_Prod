...
Section removal is configured in .env (COURSE_MARKDOWN_REMOVE_SECTIONS), including:
Course content, Careers and your future, Teaching and learning, Assessment and feedback,
Location of study (and nested Related courses), and marketing ranking headings (*ranked*).
"""
