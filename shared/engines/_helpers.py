...
class CourseHtmlEngineHelpers:
    """DOM helpers shared by generic and utopian HTML clean engines."""
...
strip_within_block = CourseHtmlEngineHelpers.strip_within_block
derive_heading_from_block = CourseHtmlEngineHelpers.derive_heading_from_block
block_has_tabs = CourseHtmlEngineHelpers.block_has_tabs
section_body_without_duplicate_heading = CourseHtmlEngineHelpers.section_body_without_duplicate_heading
overseas_fee_from_napier_table = CourseHtmlEngineHelpers.overseas_fee_from_napier_table
